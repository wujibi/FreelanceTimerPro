"""
Burnt Orange Professional V2 - Two-Tone Orange Hierarchy
Uses light peach for group headings, full orange for selections
Creates visual hierarchy while staying brand-consistent
"""

def get_colors():
    """Return the color palette for Burnt Orange Professional V2 theme"""
    return {
        ...
        'group_heading': '#f4a460',        # LIGHT PEACH/SALMON for group headings
        'group_text': '#13100f',           # Dark text on light peach
    }
...
def apply_theme(style, colors, fonts):
    """Apply the Burnt Orange Professional V2 theme to ttk widgets"""
    ...
    print(f"[THEME] Burnt Orange Professional V2 (Two-Tone Orange) theme applied successfully")
