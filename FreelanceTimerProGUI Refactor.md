...
- **Tkinter UI layer**
  ...
  - \[app/ui/tk/\_\_init\_\_.py\](app/ui/tk/\_\_init\_\_.py): exports the Tkinter App class.
...
- **1. Introduce a minimal App class and entrypoint**
  ...
  - If gui.py currently runs code at module import (if \_\_name\_\_ == \"\_\_main\_\_\" block or top-level widget creation), move that into \[app/main.py\](app/main.py) or a new entry file.
...
- **8. Keep packaging working**
  ...
  - Ensure the entry script used for your .exe (e.g. the target in PyInstaller spec) now points at \[app/main.py\](app/main.py) or whichever module owns the if \_\_name\_\_ == \"\_\_main\_\_\" block.
...
- **1. Introduce a parallel PyQt6 UI package**
  ...
  - Create a new package, for example:
    ...
    - \[app/ui/qt/\_\_init\_\_.py\](app/ui/qt/\_\_init\_\_.py)
